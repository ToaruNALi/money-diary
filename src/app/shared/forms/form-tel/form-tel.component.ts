...
@Component({
  ...
  templateUrl: './form-tel.component.html',
  styleUrl: '../forms.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FormTelComponent extends FormsComponent {
  protected override readonly type = Const.INPUT_TYPE.TEL;
}
